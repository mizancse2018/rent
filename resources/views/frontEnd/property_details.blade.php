                ...
                <div class="row">
                            ...
                            <div class="carousel-inner">
                                ...
                                @foreach($post->image as $key)
                                    <div class="carousel-item {{ $i == '1'? 'active':'' }}">
                                        @php $i++; @endphp
                                        <img src="{{ asset('assets/frontEndAsset/img/propertyImages/'.$key->image) }}" class="d-block w-100 img-fluid" style="width:100%;height: 350px;" alt="property">
                                    </div>
                                @endforeach
                            </div>
                    ...
                    <div class="col-12 col-md-6 col-lg-6 pb-3">
                        <div class="properties-content-info">
                            ...
                            <br>
                            <div>
                                <a href="{{ route('take.rent',['id'=>$post->id])}}" class="btn btn-dark">Take Rent</a>
                            </div>
                        </div>
                    </div>
