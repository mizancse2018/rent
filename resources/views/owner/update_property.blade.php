            ...
            <div class="card">
                <div class="card-header py-3 bg-transparent">
                    ...
                    <div class="d-sm-flex align-items-center">
                        <h5 class="mb-2 mb-sm-0">Update Property</h5>
                    </div>
                </div>
                <div class="card-body">
                    <div class="col-lg-12">
                        <label for="">Multiple property image</label>
                        <div class="row">
                            @if (count($posts->image)>0)
                                @foreach ($posts->image as $img)
                                    <div class="col-lg-2">
                                        <form action="{{ route('delete.image',['id'=>$img->id]) }}" method="post">
                                            <button class="float-end btn text-danger">X</button>
                                            @csrf
                                            @method('delete')
                                        </form>
                                        <img src="{{ asset('assets/frontEndAsset/img/propertyImages/'.$img->image)}}" class="img-fluid" style="width: 100px; height: 100px;" alt="">
                                    </div>
                                @endforeach
                            @endif
                        </div>
                    </div>
                    <form class="form" action="{{ route('update.property',['id'=>$posts->id]) }}" method="post" enctype="multipart/form-data">
                        @csrf
                        @method("put")
                        <div class="row g-3">
                                ...
                                <div class=" shadow-none bg-light border">
                                    <div class="card-body row g-3">
                                        <div class="col-12 col-lg-8">
                                            ...
                                            <input type="text" class="form-control" name="property_title" placeholder="property_title" value="{{ $posts->property_title }}">
                                        </div>
                                        ...
                                        <div class="col-12 col-lg-4">
                                            ...
                                            <select  id="division-dropdown" class="form-control" name="division">
                                                <option value="{{ $posts->division }}">-- Select Division --</option>
                                        ...
                                        <div class="col-12 col-lg-4">
                                            ...
                                            <select id="district-dropdown" class="form-control" name="district">
                                                <option value="{{ $posts->district }}"></option>
                                            </select>
                                        </div>
                                        <div class="col-12 col-lg-4">
                                            <label class="form-label" for="">Area</label>
                                            <select id="area-dropdown" class="form-control" name="area">
                                                <option value="{{ $posts->area }}"></option>
                                            </select>
                                        </div>
                                        <div class="col-12 col-lg-4">
                                            <label class="form-label" for="">Thana</label>
                                            <input type="text" class="form-control" name="thana" placeholder="Thana" value="{{ $posts->thana }}">
                                        </div>
                                        <div class="col-12 col-lg-4">
                                            <label class="form-label" for="">Post Code</label>
                                            <input type="text" class="form-control" name="post_code" placeholder="Post Code" value="{{ $posts->post_code }}">
                                        </div>
                                        <div class="col-12 col-lg-4">
                                            <label class="form-label" for="">Road</label>
                                            <input type="text" class="form-control" name="road" placeholder="Road" value="{{ $posts->road }}">
                                        </div>
                                        <div class="col-12 col-lg-2">
                                            <label class="form-label" for="">Price</label>
                                            <input type="text" class="form-control" name="price" placeholder="Per Month" value="{{ $posts->price }}">
                                        </div>
                                        <div class="col-12 col-lg-2">
                                            <label class="form-label" for="">Holding</label>
                                            <input type="text" class="form-control" name="holding" placeholder="Holding" value="{{ $posts->holding }}">
                                        </div>
                                        <div class="col-12 col-lg-2">
                                        ...
                                        <div class="col-12 col-lg-12">
                                            ...
                                            <div class="col-12 col-lg-12 py-3">
                                                ...
                                                <textarea class="form-control" name="description" placeholder="Description" rows="4" cols="4">{{ $posts->description }}</textarea>
                                            </div>
