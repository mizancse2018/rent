...
class SslCommerzPaymentController extends Controller
{
    ...
    public function payViaAjax(Request $request)
    {
        ...
        $post_data = array();
        $post_data['post_id'] = $requestData['post_id'];
        $post_data['tenant_id'] = $requestData['tenant_id'];
        $post_data['owner_id'] = $requestData['owner_id'];
    ...
    public function success(Request $request)
    {
        ...
        if ($order_details->status == 'Pending') {
            ...
            if ($validation) {
                ...
                in order table as Paid or Complete.
                ...
                */
                ...
                echo "<br>Transaction ID is $tran_id";
            }
        ...
        $rent_details = DB::table('rents')
            ->where('transaction_id', $tran_id)
            ->select('booking_status')->first();

        if ($rent_details->booking_status == '') {
            $validation = $sslc->orderValidate($request->all(), $tran_id, $amount, $currency);
            ...
            if ($validation) {
                ...
                */
                ...
                echo "<br>Booking is successfully Completed";

            }
        } else if ($rent_details->booking_status == 'booked' || $rent_details->booking_status == 'Complete') {
            /*
             That means through IPN Order status already updated. Now you can just show the customer that transaction is completed. No need to udate database.
             */
        } else {
            #That means something wrong happened. You can redirect customer to your product page.
            echo "Booking Invalid";
        }
    }
